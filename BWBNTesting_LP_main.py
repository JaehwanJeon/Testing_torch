...
model_paths = [os.path.normpath(os.path.join(model_dir, './' + LPTitle + '_checkpoint_{}.pth'.format(i+checkpoint_epoch))) for i in range(0, num_epochs, checkpoint_epoch)]
# model_paths = [os.path.normpath(os.path.join(model_dir, './' + LPTitle + '_checkpoint_925.pth'))]
